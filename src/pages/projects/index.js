...
const FeaturedProject = ({ type, title, summary, img, link, github }) => {
  return (
    <article className="w-full flex items-center justify-between rounded-3xl border border-solid border-dark dark:border-light bg-light dark:bg-dark shadow-2xl p-12 relative rouded-br-2xl">
      ...
      <div className="w-1/2 flex flex-col items-start justify-between pl-6">
        ...
        <div className="mt-2 flex items-center">
          ...
          <Link
            className="ml-4 rounded-lg bg-dark text-light p-2 px-6 text-lg font-semibold border border-transparent dark:bg-light dark:text-dark hover:dark:bg-dark hover:dark:text-light hover:dark:border-light"
            href={link}
            target="_blank"
          >
            Visit project

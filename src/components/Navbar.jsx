...
const CustomMobileLink = ({ url, title, className = "", toggle }) => {
...
const Navbar = () => {
  ...
  return (
    <header className="w-full px-32 py-8 font-medium flex justify-between dark:text-light relative">
      <button
        onClick={handleClick}
      ...
      {isOpen && (
        <motion.div
          ...
          className="min-w-[70vw] flex flex-col items-center justify-between z-30 fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-dark/90 dark:bg-light/75 rounded-lg backdrop-blur-md py-32 gap-y-8"
        >
